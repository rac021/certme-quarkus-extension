...
public class Config   {
   ...
   private final String KEY_BINDING_INTERF = "certme_binding_interface"  ;
   ...
   private final String KEY_CERTIF_KEY     = "certme_key_file_name"      ;
   private final String KEY_USER_KEY       = "certme_user_key_file_name" ;
   ...
   public Config() throws Exception {
     ...
     this.BINDING_INTERFACE          = ( getOrDefault( KEY_BINDING_INTERF , "0.0.0.0"  ) )              ;
   ...
   private String getOrDefault( String key, String defValue )    {
    ...
    private Boolean getOrDefault( String key, boolean defValue ) {
       ...
       return value != null          && 
            ! value.trim().isEmpty() &&
            value.trim().equalsIgnoreCase( "TRUE") ? true : defValue ;
    }
